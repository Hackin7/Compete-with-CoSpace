...
bool WT_R(){
	...
	else if ((US_Front<10 && US_Right<10 && US_Left<10))
	{
		WheelRight=3;
		WheelLeft=-5;
	}
	else if (US_Right<10 && US_Left<10)
	{
		WheelRight=4;
		WheelLeft=-4;
	}
	else if (US_Front<15 && US_Right<15) // reach corner turn left
	{
		WheelLeft=2;
		WheelRight=5;
	}
