...
bool boundary(int border){
    //int PositionX1 = PositionX,PositionY1=PositionY;
    //printf("PositionX and Y:%d,%d Time: %d\n", PositionX1, PositionY1, Time);
...
bool boundary2(int border){
    ...
    if(PositionX1<=x1 ){WheelLeft=3;WheelRight=-3;return true;}
    else if(PositionX1<=x1 ){WheelLeft=-3;WheelRight=3;return true;}
    else if(PositionX1>=x2 ){WheelLeft=3;WheelRight=-3;return true;}
    else if(PositionX1>=x2){WheelLeft=-3;WheelRight=3;return true;}
    else if (PositionY1<=y1){
        WheelLeft=3;WheelRight=-3;return true;
    }
    else if (PositionY1<=y1 ){
        WheelLeft=-3;WheelRight=3;return true;
    }
    else if (PositionY1>=y2){
        //cout<<"Up";
        //WheelLeft=3;WheelRight=0;
        WheelLeft=3;WheelRight=-3;return true;
    }
